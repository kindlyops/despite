...
var config  = {
  ...
  output: {
    path: path.join(__dirname, 'src/despite/data/static/build'),
  ...
  resolve: {
    ...
    alias: {
      ...
      '#c': path.join(__dirname, 'src/client/components'),
  ...
  postcss: function() {
    return [autoprefixer, precss({
      variables: {
        variables: require('./src/client/css/vars')
      }
    }), functions({
      functions: require('./src/client/css/funcs')
    })]
  }
};
